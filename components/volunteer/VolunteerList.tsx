          ...
          >
            <div className="p-6">
              <div className="flex gap-4">
                ...
                <div className="w-64 h-44 bg-gray-200 rounded-xl flex items-center justify-center overflow-hidden flex-shrink-0">
      ...
      */}
      {events.length === 0 && (
        <div className="text-center py-12">
          <p className="text-xl text-gray-500">No volunteer opportunities found matching your search.</p>
        </div>
      )}
    </div>
  )
