    ...
    <nav className="bg-white border-b border-gray-200 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link className="text-2xl font-bold text-green-800" href="/">
            ʻĀina Bucks
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button className="px-6 py-2.5 bg-green-700 text-white font-semibold hover:bg-green-800 hover:scale-105">
            Join Now
          </Button>
        </div>
      </div>
